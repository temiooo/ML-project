...
SR_image = np.squeeze(output_)
SR_image = np.array(SR_image)


psnr_lr = peak_signal_noise_ratio(HR_image, LR_image)
psnr_sr = peak_signal_noise_ratio(HR_image, SR_image)

print("psnr for LR_image", psnr_lr)
print("psnr for SRCNN", psnr_sr)

iio.imsave("sr_image.png", SR_image)
iio.imsave("lr_image.png", LR_image)
iio.imsave("hr_image.png", HR_image)
